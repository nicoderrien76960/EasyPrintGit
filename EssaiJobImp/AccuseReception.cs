...
namespace EssaiJobImp
{
    class AccuseReception 
    {
        ...
        public void chargementXML()
        {
            ...
            try
            {
                unxml.Load("baliseConfAR.config");                    //Le document de configuration des balises lu doit être découper en trois corps (Entete, Corps, Pied)
                unxmlBody.Load("baliseConfAR.config");
                unxmlFoot.Load("baliseConfAR.config");
            }
            catch
            { }
