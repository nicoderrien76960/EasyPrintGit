    ...
    class GestionListeDoc
    {
        ...
        public void chargementXML()
        {
            ...
            foreach (XmlNode unNode in node)
            {
                ...
                {
                    if (unNode2.Name == "NomComplet")// Si le noeud imprimante est vu, alors on récupère son contenu
                    {
                ...
                donneeListDoc.Add(bal.Trim(), imprimante);// Ajout dans le dictionnaire
            }
        }
