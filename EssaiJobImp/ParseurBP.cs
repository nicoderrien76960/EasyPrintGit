...
namespace EssaiJobImp
{
    class ParseurBP
    {
        ...
        public ParseurBP(Dictionary<string, string>donneeEntete, Dictionary<string, string>donneeBody, Dictionary<string,string>donneeFoot, int iBody, int iFoot, string nomDoc)
        {
